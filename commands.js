...
const slashCommands = [
    ...
    // -- Ranked Play pricing panel --------------------------------------------
    {
        ...
        async execute(interaction){
            ...
            const ranks = {
                bronze: emojiTag(interaction.client, "1523088078183469086", "Bronze"),
                silver: emojiTag(interaction.client, "1523088147326566652", "Silver"),
                gold: emojiTag(interaction.client, "1523088229106974790", "Gold"),
                platinum: emojiTag(interaction.client, "1523088273876975618", "Platinum"),
                diamond: emojiTag(interaction.client, "1523088389807673454", "Diamond"),
                crimson: emojiTag(interaction.client, "1472692153837813957", "Crimson"),
                iridescent: emojiTag(interaction.client, "1523088484582297721", "Iridescent"),
                top250: emojiTag(interaction.client, "1503807783303249960", "⭐")
            };
            const arrow = emojiTag(interaction.client, "1523104345854574684", "→");
