            ...
            const embed = brandEmbed({
                ...
                fields: [
                    { name: "🎯 Multiplayer (MP)", value:
                        ...
                        "2️⃣ 🌌 Arclight\n" +
                        "3️⃣ ⚡ Tempest\n" +
                        "4️⃣ 🌌 **Singularity** *(final MP mastery)*"
                    },
                    { name: "🧟 Zombies (ZM)", value:
                        "1️⃣ 🐉 Golden Dragon\n" +
                        "2️⃣ 💎 Bloodstone\n" +
                        "3️⃣ 🔥 Doomsteel\n" +
                        "4️⃣ 👾 **Infestation** *(final Zombies mastery)*"
                    },
                    { name: "🎮 Campaign / Endgame", value:
                        "1️⃣ 🟡 Molten Gold\n" +
                        "2️⃣ 🌙 Moonstone\n" +
                        "3️⃣ 🌈 Chroma Flux\n" +
                        "4️⃣ 🟢 **Genesis** *(final Campaign mastery)*"
                    },
                    { name: "🪂 Warzone (WZ)", value:
                        "1️⃣ 🟨 Golden Damascus\n" +
                        "2️⃣ ✨ Starglass\n" +
                        "3️⃣ ❄️ Absolute Zero\n" +
                        "4️⃣ ☢️ **Apocalypse** *(final Warzone mastery)*"
                    }
                ],
                thumbnail: false
            });
            ...
            if(shoukaku){
                ...
                if(!nodes.length){
                    lavalinkStatus = "❌ no nodes configured\n" +
                        "(the node failed to connect enough times that it got dropped from the pool - " +
                        "double-check LAVALINK_HOST has NO `http(s)://` or `wss://` prefix, and that " +
                        "LAVALINK_PORT/PASSWORD/SECURE match your Lavalink server exactly. It'll keep " +
                        "auto-retrying every 30s in the background once those are fixed - no restart needed.)";
                }else{
