...
const { LOOP_OFF, LOOP_TRACK, LOOP_QUEUE } = require("./music-queue");
...
function buildMusicButtons(queue){
    ...
    const row3 = new ActionRowBuilder().addComponents(
        new ButtonBuilder().setCustomId("music_addplaylist").setEmoji("➕").setLabel("Add to Playlist").setStyle(ButtonStyle.Secondary)
    );
